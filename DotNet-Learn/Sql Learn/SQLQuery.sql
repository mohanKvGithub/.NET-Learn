...
-- NOT
-- ======================================================================================================================================================
select * from Products where not IsActive=0
go
...
-- SUBSTRING(), LEN()
-- ======================================================================================================================================================
select SUBSTRING(Phone,len(Phone)-3,4) as Last4Digits, Phone from Customers --SUBSTRING(string, start, length)
go
-- ======================================================================================================================================================
-- REPLACE()
-- ======================================================================================================================================================
select REPLACE(Phone,SUBSTRING(Phone,len(Phone)-3,4),'0000') from Customers --EPLACE(string, old_string, new_string)
go
-- ======================================================================================================================================================
-- REVERSE()
-- ======================================================================================================================================================
...
select right(Phone,4), Phone from Customers --RIGHT(string, number_of_chars)
go
-- ======================================================================================================================================================
-- LEFT()
-- ======================================================================================================================================================
...
select LEFT(Phone , 4), Phone from Customers --LEFT(string, number_of_chars)
go
-- ======================================================================================================================================================
-- TRIM(), LTRIM(), RTRIM()
-- ======================================================================================================================================================
